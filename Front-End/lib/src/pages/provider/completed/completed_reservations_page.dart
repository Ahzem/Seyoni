...
import 'package:seyoni/src/pages/provider/completed/completed_reservation_detail_page.dart';import 'dart:convert';
...
class CompletedReservationsPage extends StatefulWidget {
  const CompletedReservationsPage({super.key});

  @override
  CompletedReservationsPageState createState() =>
      CompletedReservationsPageState();
}

class CompletedReservationsPageState extends State<CompletedReservationsPage> {
  ...
  Widget build(BuildContext context) {
    return BackgroundWidget(
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.transparent,
          title: const Text('Completed Reservations',
                                          ...
                                          TextButton(
                                            onPressed: () async {
                                              final result =
                                                ...
                                                MaterialPageRoute(
                                                  builder: (context) =>
                                                      CompletedReservationDetailPage(
                                                    reservationId:
                                                        reservation['_id'],
                                                  ),
                                                ),
