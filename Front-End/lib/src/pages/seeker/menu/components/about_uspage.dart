...
class AboutUsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BackgroundWidget(
      child: Scaffold(
        ...
        body: Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16.0), // Reduce vertical padding,
          child: Center(
            child: Column(
              mainAxisAlignment: MainAxisAlignment.start, // Align content to the top
              children: [
                // Card with content
                Expanded( // Allow the card to take up available vertical space
                  child: Card(
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: kSubtitleTextStyle.copyWith(fontSize: 10.0, color: kParagraphTextColor),
  ...
  children: [
    ...
    SizedBox(width: 4.0), // Add space between the text and the logo
    Image.asset(
      'assets/images/logo-icon.png', // Path to the logo image
      height: 10,
      width: 10,
